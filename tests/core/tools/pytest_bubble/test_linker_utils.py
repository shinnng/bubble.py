...
from bubble.tools.pytest_bubble._utils import (
...
@pytest.fixture
def chain_setup(w3):
    old_chain_id = remove_0x_prefix(to_hex(w3.bub.get_block(0)["hash"]))
    block_hash = remove_0x_prefix(to_hex(w3.bub.get_block("earliest").hash))
